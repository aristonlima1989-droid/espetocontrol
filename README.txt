...
VERSÃO 2.1
- Editar/inativar/reativar/resetar senha de usuários.
- Tipos de produto: AVULSO, SIMPLES, COMPLETO, BEBIDA.
- Composição de produtos SIMPLES/COMPLETO com vários itens.
- Dashboard com pedidos prontos e ticket médio.
